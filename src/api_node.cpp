...
ApiNode::ApiNode(const rclcpp::NodeOptions &options) : rclcpp_lifecycle::LifecycleNode("api_node", "", options) {
  RCLCPP_INFO(get_logger(), "Creating");
	...
	declare_parameter("offboard.position", false);
	declare_parameter("offboard.velocity", false);
	declare_parameter("offboard.acceleration", false);
	declare_parameter("offboard.attitude", false);
	declare_parameter("offboard.thrust_and_torque", false);
...
void ApiNode::getParameters() {
	...
	get_parameter("offboard.position", _offboard_position_);
	get_parameter("offboard.velocity", _offboard_velocity_);
	get_parameter("offboard.acceleration", _offboard_acceleration_);
	get_parameter("offboard.attitude", _offboard_attitude_);
	get_parameter("offboard.thrust_and_torque", _offboard_thrust_and_torque_);
	get_parameter("offboard.body_rate", _offboard_body_rate_);
	get_parameter("offboard.direct_actuator", _offboard_direct_actuator_);
}
// >>>
